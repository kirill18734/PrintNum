# <img src="./public/favicon.ico" width="50em"> PrintNum — программа для печати номеров ячеек Ozon

**PrintNum** — бесплатное Windows-приложение для автоматической печати номеров ячеек и складских этикеток Ozon. Программа интегрируется с сайтом Ozon через браузерное расширение и помогает ускорить процессы приемки товаров, выдачи заказов, возвратов, упаковки и работы на складе.
